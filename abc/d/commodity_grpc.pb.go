...
type CommoditiesClient interface {
	...
	List(ctx context.Context, in *_go.User, opts ...grpc.CallOption) (Commodities_ListClient, error)
...
func (c *commoditiesClient) List(ctx context.Context, in *_go.User, opts ...grpc.CallOption) (Commodities_ListClient, error) {
...
type CommoditiesServer interface {
	...
	List(*_go.User, Commodities_ListServer) error
...
func (UnimplementedCommoditiesServer) List(*_go.User, Commodities_ListServer) error {
...
type CouponsClient interface {
	...
	List(ctx context.Context, in *_go.User, opts ...grpc.CallOption) (Coupons_ListClient, error)
}
...
func (c *couponsClient) List(ctx context.Context, in *_go.User, opts ...grpc.CallOption) (Coupons_ListClient, error) {
...
type CouponsServer interface {
	...
	List(*_go.User, Coupons_ListServer) error
...
func (UnimplementedCouponsServer) List(*_go.User, Coupons_ListServer) error {
	return status.Errorf(codes.Unimplemented, "method List not implemented")
}
