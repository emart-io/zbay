...
export class Message extends jspb.Message {
  ...
  clearimagesList(): Message;
  addImages(value: string, index?: number): Message;
  videosList: Array<string>;
  clearvideosList(): Message;
  addVideos(value: string, index?: number): Message;
  to: string;
  from: string;
  annotationsMap: jspb.Map<string, string>;
  clearannotationsMap(): Message;
  created: google_protobuf_timestamp_pb.Timestamp | undefined;
  hascreated(): boolean;
  clearcreated(): Message;
