...
goog.exportSymbol('proto.zbay.Position', null, global);
/**
 ...
 * @constructor
 */
proto.zbay.Position = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.zbay.Position, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.zbay.Position.displayName = 'proto.zbay.Position';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.zbay.Order.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.zbay.Position;
      reader.readMessage(value,proto.zbay.Position.deserializeBinaryFromReader);
...
proto.zbay.Order.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.zbay.Position.serializeBinaryToWriter
    );
  }
...
Object.defineProperty(proto.zbay.Order.prototype, "commodityId", {
  set: function(value) {
 ...
 * @return {string}
 */
proto.zbay.Order.prototype.getCommodityId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.zbay.Order.prototype.setCommodityId = function(value) {
 ...
 * @return {?proto.zbay.Position}
 */
proto.zbay.Order.prototype.getDestination = function() {
  return /** @type{?proto.zbay.Position} */ (
    jspb.Message.getWrapperField(this, proto.zbay.Position, 4));
};


/** @param {?proto.zbay.Position|undefined} value */
 ...
 * @return {!Object}
 */
proto.zbay.Position.prototype.toObject = function(opt_includeInstance) {
  return proto.zbay.Position.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.zbay.Position} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zbay.Position.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.zbay.Position}
 */
proto.zbay.Position.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.zbay.Position;
  return proto.zbay.Position.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.zbay.Position} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.zbay.Position}
 */
proto.zbay.Position.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.zbay.Position.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.zbay.Position.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.zbay.Position} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zbay.Position.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
...
Object.defineProperty(proto.zbay.Position.prototype, "name", {
  set: function(value) {
    this.setName(value);
  },
  get: function() {
 ...
 * @return {string}
 */
proto.zbay.Position.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.zbay.Position.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};


Object.defineProperty(proto.zbay.Position.prototype, "location", {
  set: function(value) {
 ...
 * @return {string}
 */
proto.zbay.Position.prototype.getLocation = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.zbay.Position.prototype.setLocation = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};


Object.defineProperty(proto.zbay.Position.prototype, "address", {
  set: function(value) {
 ...
 * @return {string}
 */
proto.zbay.Position.prototype.getAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.zbay.Position.prototype.setAddress = function(value) {
  jspb.Message.setProto3StringField(this, 3, value);
};
